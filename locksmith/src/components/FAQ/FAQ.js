...
const faqs = [
  ...
  { question: "Can a locksmith open any lock?", answer: "Yes, our locksmiths are trained to open all types of locks, including residential door locks, commercial security locks, car locks, and digital keypads. We use professional tools to unlock doors safely without damaging the lock or door frame. Before confirming the details, choose the category you need assistance with—<strong>Commercial, Residential, Automotive, or Digital</strong>—so we can provide the right service tailored to your needs." },
  ...
  { question: "How long does it take for a locksmith to arrive?", answer: "Our locksmiths strive to reach your location as quickly as possible. In most cases, we offer fast response times, typically within 30–60 minutes, depending on your location and service availability." },
];
  ...
  return (
    <div className="faq-container">
      ...
      <div className="faq-grid">
        {faqs.map((faq, index) => (
          <div key={index} className={`faq-card ${openIndex === index ? "expanded" : ""}`}>
            <button
