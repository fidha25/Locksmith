...
// //                 I agree to the <a href="/docs/Terms of Use.pdf" target="_blank" rel="noopener noreferrer">Terms of use</a>and <a href="/docs/Terms of Use.pdf" target="_blank" rel="noopener noreferrer">Privacy policy</a>
// //               </label>
// //             </div>
...
//               <p>Already have an account? <Link to="/login?role=locksmith">Login</Link></p>
//             </div>
//           </form>
//           {totpData && (
//             <div className="mt-4 p-3 border rounded text-center">
