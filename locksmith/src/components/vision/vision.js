      ...
      <Container>
        <Row className="align-items-center">
          ...
          <Col md={6} className="text-content">
            ...
            <p>
            Finding a <b>trusted locksmith in Brisbane, Canberra, Sydney, Melbourne, Adelaide, or Perth</b> can be challenging, but with <b>LockQuick</b>, you get the best service wherever you are.            </p>
            <Row>
              <Col md={6}>
                <div className="icon-box">
                  <div className="transparent-box">
                    ...
                    <p>To be the most <b>trusted locksmith service provider across Australia</b>, delivering top-tier security solutions with integrity and professionalism.</p>
                  </div>
                </div>
              </Col>
              <Col md={6}>
                <div className="icon-box">
                  <div className="transparent-box">
                    ...
                    <p>To provide <b>fast, efficient, and affordable locksmith solutions</b>, integrating the latest security technologies for <b>homes, businesses, and vehicles</b>.</p>
                  </div>
                </div>
              </Col>
