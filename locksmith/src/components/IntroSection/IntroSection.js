...
//   const headingText = "LOCK QUICK – FAST & RELIABLE LOCKSMITH SERVICES IN AUSTRALIA";
...
//       <Container fluid className="text-center content-overlay">
//         <Row className="justify-content-center align-items-center">
//           <Col md={10} lg={8} className="text-content">
//             <h1 className="intro-heading">
...
//               ))}
//             </h1>
//             <h4 className="text-light"  data-aos="fade-up"><b>24/7 Emergency Locksmith Services – Anytime, Anywhere!</b></h4>
//             <p  data-aos="fade-up">
//               Locked out? Need urgent lock repairs? <b>Lock Quick</b> offers <b>affordable 24-hour locksmith support</b> with fast mobile solutions across Australia.
//             </p>
//             <div className="d-flex justify-content-center align-items-center w-100 service-dropdown-container"  data-aos="fade-up">
//               <Dropdown onSelect={handleSelect}>
//                 <Dropdown.Toggle style={{ backgroundColor: "white", color: "black", width: "300px" }} id="dropdown-basic">
//                   {selectedService}
//                 </Dropdown.Toggle>
